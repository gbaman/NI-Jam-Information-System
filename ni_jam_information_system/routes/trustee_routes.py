...
@trustee_routes.route("/volunteer_attendance_remind_slack/<jam_id>")
@trustee_required
@module_slack_required
@module_volunteer_attendance_required
def volunteer_attendance_remind_slack(jam_id):
